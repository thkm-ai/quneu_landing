    ...
    <section ref={sectionRef} className="py-24 px-6 relative overflow-hidden">
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-thin mb-4 text-slate-900 text-ethereal">
            QUNEU RUNS ON TODAY'S <span className="text-gradient-cosmic">HARDWARE</span>
          </h2>
          <h3 className="text-2xl md:text-3xl text-slate-800 mb-6 font-light text-whisper">
            NO QUANTUM COMPUTERS INVOLVED
          </h3>
          <p className="text-xl text-slate-700 font-light text-airy">
          ...
          <div className="flex items-center justify-center gap-8 md:gap-12">
            ...
            >
              ...
              <div className="h-12 flex items-end justify-center">
                <p className="text-sm md:text-base text-slate-700 font-light text-airy text-center">QUNEU Simulation</p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-center flex-shrink-0 -mt-8">
              <div className="flex items-center justify-center w-12 h-12 md:w-16 md:h-16">
                ...
                <div className="relative">
                  <div className="w-8 md:w-10 h-1 bg-red-500 rounded"></div>
                  <div className="w-1 h-8 md:h-10 bg-red-500 rounded absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"></div>
                </div>
              </div>
            </div>
            ...
            <div className="text-center transition-all duration-500 flex-shrink-0 flex flex-col">
              <div className="relative w-40 h-40 md:w-52 md:h-52 mx-auto mb-4">
                <Image src="/images/gpu-chip.png" alt="GPU Chip" fill className="object-contain" />
              </div>
              <div className="h-12 flex items-center justify-center">
                <p className="text-sm md:text-base text-slate-700 font-light text-airy text-center">
            ...
            <div className="flex items-center justify-center flex-shrink-0 -mt-8">
              <div className="flex items-center justify-center w-12 h-12 md:w-16 md:h-16">
                {/* Equals sign */}
                <div className="relative">
                  <div className="w-8 md:w-10 h-1 bg-red-500 rounded mb-2"></div>
                  <div className="w-8 md:w-10 h-1 bg-red-500 rounded"></div>
                </div>
              </div>
            </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 text-center">
          {["Instant", "Scalable", "Ready"].map((benefit, index) => (
            ...
            >
              <div className="text-3xl md:text-4xl font-thin text-slate-800 mb-2 text-ethereal">{benefit}</div>
        ...
        <div className="text-center mt-16 py-8">
          <p className="text-xl md:text-2xl text-slate-700 mb-2 font-light text-airy">
            Veteran Innovators with Decades of Expertise
          </p>
          <p className="text-lg md:text-xl text-red-500 font-light text-whisper">
